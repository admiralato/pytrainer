...
class FootAction(MBase):
    ...
    def extractProductData(self):
        ...
        try:
            item["category"] = "basketball shoes"
    ...
    def __getDescription(self):
        item_list = []
        node_collection = self.getElementValues("//div[@id='pdp_content']/div/div/h1|//table["
                                                "@class='product_description']/tr/td/span/p|//table["
                                                "@class='product_description']/tr/td/span/ul/li")
        if node_collection is not None and len(node_collection) > 0:
            indx = 0
            for node in node_collection:
