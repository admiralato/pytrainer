...
class ForeverTwentyOne(MBase):
    ...
    def __getDescription(self):
        item_list = []
        node_collection = self.getElementValues("//h1[@class='item_name_p']|//div["
                                                "@class='description_wrapper']/section/div/article/section/div/span")
        if node_collection is not None and len(node_collection) > 0:
            indx = 0
            for node in node_collection:
