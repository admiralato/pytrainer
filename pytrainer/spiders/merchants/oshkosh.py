...
class OshKosh(MBase):
    ...
    def extractProductData(self):
        ...
        try:
            item["category"] = "baby & toddler shoes"
    ...
    def __getDescription(self):
        item_list = []
        node_collection = self.getElementValues("//h1[@class='product-name']|//div[@id='tab2']|//ul["
                                                "@class='benefits']/li|//ul[@class='benefits']/li/a|//ul["
                                                "@class='customSpecs']/li|//ul["
                                                "@class='customSpecs']/li/a")
        if node_collection is not None and len(node_collection) > 0:
            indx = 0
            for node in node_collection:
